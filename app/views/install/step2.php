        ...
        <form action="/install/database" method="post" data-ajax="true">
            ...
            <div id="ownerFields" class="license-fields d-none">
                <div class="alert alert-info">
                    Owner license is intended for platform owner deployments. This option appears only when owner mode is already enabled; if it is missing, set <code>OWNER_LICENSE_ENABLED=true</code> and <code>OWNER_INSTALL_TOKEN</code> in <code>.env</code> before opening the installer.
                </div>
